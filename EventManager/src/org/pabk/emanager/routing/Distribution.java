...
public final class Distribution {
	private static final String distFile="conf/distribution_list2.xml";
	...
	private static String codeRepositoryFile="conf/code_repository.xml";
	
	private Distribution() {
	}
	
	public static void init() throws Exception {
		FileInputStream in=new FileInputStream(distFile);
		...
		in.close();
		in=new FileInputStream(codeRepositoryFile);
		doc=db.parse(in);
