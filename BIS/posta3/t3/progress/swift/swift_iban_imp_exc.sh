...
#  Pre potreby importu IBAN Directory Plus súborov upravil Branislav Brandys
#  PBIT, a.s., 20.01.2016
# 
...
#Zmena oproti swiftimp.h, meno doèasného súboru bude upravené pre potreby IBAN Directory Plus (Brandys, 20.01.2016)
...
#Zmena oproti swiftimp.h, meno log súboru bude upravené pre potreby IBAN Directory Plus (Brandys, 20.01.2016)
...
#FLAG_FILE=${L_ADR}/ibanexcl_sts.txt
