...
MASKA="[I][B][A][N][S][T][R][U][C][T][U][R][E][_][F][U][L][L][_][2][0][0-9][0-9][01][0-9][0-3][0-9].[Xx][Mm][Ll]"
...
TMP=${L_ADR}/tmp/tran_iban_imp_str_tmp.$$
...
SUM_LOG=${L_ADR}/log/tran_iban_imp_str.log

#pridane Branislav Brandys, premenne pre flag subor
FLAG_FILE=${L_ADR}/../work/uzav/bis_in/ibanstruc_sts.txt
...
L_ADR=${L_ADR}/../work/uzav/bis_in/ibanstruc/davky
