...
#pridane Branislav Brandys, premenne pre flag subor 10.08.2016
...
#####Check INPUT parameters <<
        ...
        12)
          ...
          ;;
#Zmena oproti swiftimp.sh, pridan0 stavz pre potreby IBAN Directory Plus (Brandys, 10.08.2016)
		13)
...
set_acl() 
{
  ...
  #setacl -u user:${U_PBSWIFT}:rw-,group:${G_PBSWIFT}:rw-,other::---,user:${U_PBBIS}:rw- $1 2>$TMP
  chmod 660 $1 2>$TMP
}
