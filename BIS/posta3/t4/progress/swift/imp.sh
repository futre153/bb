...
#pridane pre potreby IBAN Plus inportu. Zadany log pre IBAN Plus (Brandys 10.08.2016)
...
if [ $POM -gt 1 ] 
  then 
    ...
    #pridane pre potreby IBAN (Brandys 10.08.2016)
	echo "`cas` IBAN IMPORT INFO Script $SCRIPT_NAME je už spustený" >> $LOG_MAIN_IBAN
    exit
fi
...
# pridane pre potreby IBAN Plus importu (Brandys 10.08.2016)
# pokial vznikne pri importe swiftovych sprav chyba zastavi sa aj import IBAN plus
