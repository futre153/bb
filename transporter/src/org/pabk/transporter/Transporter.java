...
public class Transporter extends JFrame {
	...
	public static final String PUT_INTERVAL = "putInterval";
	public static final String USERNAME = "username";
	public static final String KNOWN_HOSTS = "knownHosts";
	public static final String PRIVATE_KEY = "privateKey";
	public static final String GET_REMOTE = "getRemote";
	public static final String PUT_REMOTE = "putRemote";
	public static final String GET_LOCAL = "getLocal";
	public static final String PUT_LOCAL = "putLocal";
	public static final String GET_ARCHIVE = "getArchive";
	public static final String PUT_ARCHIVE = "putArchive";
	public static final String PASSPHRASE = "passphrase";
	public static final String MODIFY = "modify";
	public static final String GET_NEXT_RUN = "getNextRun";
	public static final String PUT_NEXT_RUN = "putNextRun";
	public static final String MASK_GET_FILE = "maskGetFile";
	public static final String MASK_PUT_FILE = "maskPutFile";
	public static final String GET_SEQUENCE = "getSequence";
	public static final String PUT_SEQUENCE = "putSequence";
	//public static String GET_SEQUENCE_FILE = "getSequenceFile";
	//public static String PUT_SEQUENCE_FILE = "putSequenceFile";
	...
	private static final String DEFAULT_PRO_PATH = "/org/pabk/transporter/default.xml";
	...
	public static void main(String[] args) {
		...
		*/
		...
		try {
			File pidFile = File.createTempFile(PID_FILE, SftpFileHandler.TMP_FILE_EXTENSION, new File(SftpFileHandler.TMP_DIRECTORY));
