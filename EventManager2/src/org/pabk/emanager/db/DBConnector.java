...
public class DBConnector extends Hashtable<String, PoolingDataSource<PoolableConnection>> {
	...
	final private static DBConnector connector = new DBConnector();
	private static final ArrayList<String> loadedDrivers = new ArrayList<String>();
	...
	final public static Connection lookup(String dsn) throws SQLException {
		try {
			return connector.get(dsn).getConnection();
		}
		catch(Exception e) {
			e.printStackTrace();
			throw e;
